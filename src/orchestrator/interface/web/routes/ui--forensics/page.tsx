...
export const ForensicCenterPage = (props: { csrfToken?: string, nonce?: string, userRole?: string }) => {
  return (
    <Layout title="Investigation Lab // Tactical Signal" islandPaths={[
      ...
      <header class="page-header animate-in fade-in slide-in-from-top-4 duration-700">
        ...
        <div class="flex items-center gap-6">
           <div class="flex items-center gap-4 bg-danger/10 border border-danger/30 px-8 py-4 rounded-full backdrop-blur-xl shadow-[0_0_20px_rgba(var(--danger-rgb),0.15)]">
              ...
              <span class="mono-xs font-black text-danger tracking-[0.4em] uppercase">Live Ingress Stream</span>
           </div>
        </div>
      </header>
      ...
      <div class="grid grid-cols-12 gap-6 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-100">
         ...
         <div class="grid grid-cols-12 gap-6">
            <div class="col-span-12 lg:col-span-8 t-panel glass-panel p-0 border-t-2 border-slate-800 flex flex-col overflow-hidden group hover:bg-white/[0.02] transition-all">
               <header class="p-8 border-b border-white/5 bg-black/40 backdrop-blur-md flex justify-between items-center">
                  ...
                  <span class="mono-xs text-slate-700 font-black tracking-widest uppercase">Window: 24H History</span>
               </header>
               <div class="p-6 bg-black/20 min-h-[300px] relative">
