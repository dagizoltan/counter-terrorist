    ...
    <Layout title="Agent Registry // Fleet Command" islandPaths={[
      ...
      <header class="page-header">
        ...
        <div class="flex gap-4">
          ...
          <button type="button" class="t-btn px-4 py-3 text-[9px]">
            Provision Node
          </button>
          )}
          {props.userRole === "admin" && (
          <button type="button" class="t-btn px-4 py-3 text-[9px] border-danger text-danger">
            Purge Failed
          </button>
          )}
        </div>
      ...
      <section class="mb-6" >
        <h2 class="eyebrow mb-5 pb-4 border-b border-white/5">01 ENDPOINT REGISTRY METADATA</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {plugins.map((agent) => (
            <div class="t-panel glass-panel group relative border-t-2 border-slate-800 hover:border-primary/40">
                <div class="flex justify-between items-start mb-5">
                  <div class="flex flex-col gap-1">
                    <div class="flex items-center gap-3">
                       ...
                       <h3 class="text-2xl font-black text-white uppercase tracking-tighter">{agent.name.toUpperCase()}</h3>
                    </div>
                    <span class="eyebrow pl-4">ID: {agent.name.slice(0, 8)} SIDE</span>
                  </div>
                ...
                <div class="bg-black/60 border border-white/5 rounded-lg p-4 mb-4">
                ...
                <div class="flex justify-between items-center pt-4 border-t border-white/5">
                  <a href={
                    ...
                    `/agents/${agent.name}`
                  } class="t-btn text-[10px] py-2 px-4">Open Agent Console</a>
                  <div class="flex gap-4">
      ...
      {/* 03_Hardening_Matrix */}
      <section class="mb-6" >
        <h2 class="eyebrow mb-5 pb-4 border-b border-white/5">02 SOVEREIGN HARDENING MATRIX</h2>
           ...
           {[
             ...
             { id: 'stat-audit-chain', label: 'AUDIT INTEGRITY', desc: 'Immutable Chain' }
              ...
              <div class="t-panel glass-panel border-t-2 border-slate-800 hover:bg-white/[0.02]">
                ...
                <div id={item.id} class="text-2xl font-bold text-white tabular-nums mb-4 uppercase tracking-tight">Initializing...</div>
                <div class="flex items-center gap-3">
                   <div class="w-1 h-3 bg-primary rounded"></div>
                   <p class="eyebrow leading-none">{item.desc}</p>
                </div>
             </div>
           ))}
        </div>
       ...
       <section class="mb-6" >
        <h2 class="eyebrow mb-5 pb-4 border-b border-white/5">03 KERNEL EXECUTION TOPOLOGY</h2>
            ...
            <header class="p-4 border-b border-white/10 flex justify-between items-center bg-black/40 backdrop-blur-md">
               <div class="flex items-center gap-4">
                  ...
                  <div>
                     ...
                     <p class="eyebrow mt-2">Causal mapping of thread lineages and unauthorized drifts</p>
                  </div>
               </div>
            ...
            <footer class="p-4 border-t border-white/5 bg-black/10 flex justify-between items-center">
               <div class="flex gap-4">
                  <div class="flex items-center gap-4">
                     ...
                     <span class="eyebrow">SOVEREIGN THREAD</span>
                  </div>
               </div>
               <span class="eyebrow">Isolation Level: <span class="text-slate-400">KERNEL STRICT</span></span>
            </footer>
        </div>
      </section>

       <section class="animate-fade-in" >
        <h2 class="eyebrow mb-5 pb-4 border-b border-white/5">04 SOVEREIGN INTEGRITY PROVENANCE</h2>
        <div class="t-panel glass-panel border-t-2 border-success/30 flex justify-between items-center p-4 group hover:bg-white/[0.02]">
           <div class="flex items-center gap-4">
              <div class="p-4 bg-success/10 border border-success/30 text-success rounded-lg">
              ...
              <div class="flex flex-col gap-2">
                 ...
                 <p class="eyebrow">All active dependencies cryptographically signed and audited</p>
              </div>
           </div>
           <a href="/system/supply-chain" class="t-btn success px-5 py-3 text-[10px] font-black uppercase tracking-[0.3em]">Inspect Full Provenance</a>
        </div>
      </section>
