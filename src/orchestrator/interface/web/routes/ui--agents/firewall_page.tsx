             ...
             <header class="p-4 border-b border-white/10 flex justify-between items-center bg-black/40 backdrop-blur-md">
                <div class="flex items-center gap-4">
                  ...
                  <div class="flex flex-col gap-2">
                     ...
                     <p class="eyebrow">Real-time packet filtration & blocklist</p>
                  </div>
                </div>
                <div class="flex items-center gap-4">
                   <div class="status-pill error font-black tracking-widest">ACTIVE_DEFENSE</div>
                </div>
             </header>

             <div class="grid grid-cols-12">
                <div class="col-span-12 lg:col-span-7 p-4 border-r border-white/5 bg-black/20">
                   <div id="fw-traffic-list" class="bg-black/80 rounded-lg p-4 border border-white/10 h-[500px] overflow-y-auto custom-scrollbar font-mono text-[11px] leading-relaxed space-y-3">
                      <div class="flex items-center gap-4 text-slate-600 uppercase tracking-[0.3em]">
                         Awaiting_Packet_Stream...
                      </div>
                   </div>
                </div>
                <div class="col-span-12 lg:col-span-5 p-4 flex flex-col gap-4 bg-black/40 backdrop-blur-sm">
                   <div class="space-y-4">
                      <h3 class="tactical-title text-xs uppercase tracking-[0.3em] text-slate-400">MANUAL_OVERRIDE</h3>
                      <div class="relative group">
                         <input id="fw-block-input" type="text" class="t-input w-full pl-5 py-4" placeholder="TARGET_IPV4" />
                      </div>
                      <button 
                        type="button"
                   ...
                   <div class="flex-grow flex flex-col">
                      <h3 class="tactical-title text-xs uppercase tracking-[0.3em] text-slate-400 mb-4 pb-2 border-b border-white/5">ACTIVE_BLOCKLIST</h3>
                      <div id="fw-blocked-list" class="flex-grow bg-black/60 border border-white/10 rounded-lg p-4 overflow-y-auto max-h-[250px] custom-scrollbar space-y-2">
