    ...
    <Layout title="Alert Relay // Governance" islandPaths={islandPaths} csrfToken={props.csrfToken} nonce={props.nonce} userRole={props.userRole}>
      ...
      <header class="page-header">
        ...
        <div class="flex items-center gap-4">
           <div class="flex items-center gap-4 bg-primary/10 border border-primary/30 px-4 py-4 rounded-full">
              <span class="dot active"></span>
              <span class="eyebrow" data-tone="primary">Pipeline_Active</span>
           </div>
        </div>
      </header>
      ...
      <div class="grid grid-cols-12 gap-4">
        ...
        <div class="col-span-12 lg:col-span-4 t-panel glass-panel group p-0 border-t-2 border-slate-800">
           <header class="p-4 border-b border-white/10 flex items-center gap-4 bg-black/40 backdrop-blur-md">
              ...
              <div>
                 ...
                 <p class="eyebrow mt-2">Provision new relay target</p>
              </div>
           </header>
           ...
           <div class="p-4 bg-black/20">
              <form id="webhook-form" class="space-y-4">
                <div class="group/field">
                  <label class="eyebrow mb-4 block group-hover/field:text-primary">Endpoint_Manifest_Name</label>
                  <input type="text" id="wh-name" placeholder="PRODUCTION_SIEM_ALERTS" class="t-input w-full pl-4 py-3" required />
                </div>
                <div class="group/field">
                  <label class="eyebrow mb-4 block group-hover/field:text-primary">Target_Webhook_URI</label>
                  <input type="url" id="wh-url" placeholder="https://hooks.relay.io/..." class="t-input w-full pl-4 py-3 font-mono text-[12px] tracking-tight" required />
                </div>
                <div class="group/field">
                  <label class="eyebrow mb-4 block group-hover/field:text-primary">Relay_Protocol_Type</label>
                  <div class="relative">
                    <select id="wh-type" class="t-input w-full pl-4 pr-6 py-3 cursor-pointer appearance-none font-black uppercase tracking-widest text-[11px]">
                ...
                <button type="submit" class="t-btn w-full py-4 mt-4 font-black uppercase tracking-[0.4em] group/btn">
                ...
                <p id="webhook-status" class="eyebrow text-center italic opacity-60 mt-4"></p>
              </form>
           </div>
        </div>
        ...
        <div class="col-span-12 lg:col-span-8 t-panel glass-panel overflow-hidden border-t-2 border-slate-800 group">
           <header class="p-4 border-b border-white/10 flex justify-between items-center bg-black/40 backdrop-blur-md">
              <div class="flex items-center gap-4">
                 ...
                 <div class="flex flex-col gap-2">
                    ...
                    <p class="eyebrow mt-1">Authorized Ingress/Egress Points</p>
                 </div>
              </div>
              <button type="button" id="test-all-btn" class="t-btn px-4 py-4 text-[10px] font-black uppercase tracking-[0.3em]">
           ...
           <div id="webhook-list" class="p-4 space-y-4 bg-black/20 min-h-[600px]">
              <div class="p-6 text-center border border-dashed border-white/5 rounded-lg opacity-20 flex flex-col items-center gap-4">
                 ...
                 <span class="eyebrow" data-tone="primary">Syncing_Relay_Registry...</span>
              </div>
           </div>
        </div>
      </div>
      ...
      <div class="mt-6">
         <div class="t-panel glass-panel p-4 border border-dashed border-white/5 rounded-lg opacity-40">
            <p class="eyebrow leading-loose text-center italic">
