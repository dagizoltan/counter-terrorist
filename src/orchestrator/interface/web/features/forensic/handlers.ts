...
export const forensicCenterHandler = async (c: Context) => {
  ...
  return c.html(jsx(ForensicCenterPage, { csrfToken, nonce, userRole }));
};
...
export const complianceCenterHandler = async (c: Context) => {
  ...
  return c.html(jsx(ComplianceCenterPage, { status, csrfToken, nonce, userRole }));
};
...
export const auditPageHandler = async (c: Context) => {
  ...
  return c.html(jsx(AuditPage, { csrfToken, nonce, hostname, userRole }));
};
