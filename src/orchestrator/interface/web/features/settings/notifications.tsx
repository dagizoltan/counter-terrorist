        ...
        <div class="bg-white/5 border border-white/5 p-8">
          ...
          <form id="webhook-form" class="space-y-6">
            ...
            <div>
              ...
              <input type="url" id="wh-url" placeholder="https://hooks.slack.c../../../services/..." class="w-full bg-black border border-white/10 text-xs font-bold p-3 outline-none focus:border-white/30" required />
            </div>
            <div>
