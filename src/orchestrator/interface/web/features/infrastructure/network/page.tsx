    ...
    <Layout title="Perimeter Shield // Active Enforcement" islandPaths={[
      ...
      <header class="page-header">
        ...
        <div class="flex gap-4">
          <button class="t-btn px-8 py-4 text-[10px] font-black group" onclick="location.reload()">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="mr-2"><path d="M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/></svg>
            Refresh_Grid_State
          </button>
        </div>
      </header>
      ...
      <div class="grid grid-cols-12 gap-6 mb-8" >
        ...
        <div class="col-span-12 lg:col-span-8 t-panel glass-panel p-0 border-t-2 border-primary/30 group">
          ...
          <div class="bg-black/60 p-8 min-h-[520px] relative">
        ...
        <div class="col-span-12 lg:col-span-4 flex flex-col gap-6">
          <div class="t-panel glass-panel stat-card border-t-2 border-primary group">
            ...
            <div class="mt-10 pt-10 border-t border-white/5">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="mr-3 group-hover/btn:rotate-180"><path d="M21 2v6h-6"/><path d="M3 12a9 9 0 0 1 15-6.7L21 8"/><path d="M3 22v-6h6"/><path d="M21 12a9 9 0 0 1-15 6.7L3 16"/></svg>
                Force_Protocol_Rotation
              </button>
            </div>
          </div>

          <div class="t-panel glass-panel p-6 hover:bg-white/[0.04] border-t-2 border-success/30 group">
            <h3 class="tactical-title text-sm mb-10 uppercase tracking-[0.3em] text-slate-400">NODE_REPUTATION_INDEX</h3>
            <div class="flex items-center gap-4 mb-10">
               <div class="flex-grow h-3 bg-white/5 rounded-full overflow-hidden">
                  <div class="h-full bg-success ease-out" style="width:98%"></div>
               </div>
               <span class="text-4xl font-black text-success tabular-nums tracking-tighter">9.8</span>
            </div>
            <div class="p-6 bg-black/60 rounded-xl border border-white/10">
      ...
      <section class="animate-fade-in" >
        ...
        <div class="t-panel glass-panel p-0 border-t-2 border-slate-800 group">
           <header class="p-6 border-b border-white/10 flex justify-between items-center bg-black/40 backdrop-blur-md">
              ...
              <div class="flex items-center gap-4">
                 <div class="px-6 py-3 bg-black/60 border border-white/10 rounded-full">
                 ...
                 <div class="status-pill error px-8 py-3 font-black tracking-widest">ACTIVE_DEFENSE_ENGAGED</div>
              </div>
           </header>

           <div class="grid grid-cols-12">
              <div class="col-span-12 lg:col-span-8 p-8 border-r border-white/5 bg-black/20">
                 <div id="fw-traffic-list" class="bg-black/80 rounded-2xl p-6 border border-white/10 h-[600px] overflow-y-auto custom-scrollbar font-mono text-[12px] leading-relaxed space-y-4">
              ...
              <div class="col-span-12 lg:col-span-4 p-8 flex flex-col gap-6 bg-black/40 backdrop-blur-sm">
                 <div class="space-y-8">
                    ...
                    <div class="relative group">
                       ...
                       <div class="absolute left-5 top-1/2 -translate-y-1/2 text-slate-600">
                    ...
                    <button 
                      ...
                      class="t-btn danger w-full py-5 font-black uppercase tracking-[0.4em] group/btn"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="mr-3 group-hover/btn:scale-125"><path d="m15 9-6 6"/><path d="m9 9 6 6"/><circle cx="12" cy="12" r="10"/></svg>
                 ...
                 <div class="flex-grow flex flex-col">
                    ...
                    <div id="fw-blocked-list" class="flex-grow bg-black/60 border border-white/10 rounded-2xl p-8 overflow-y-auto max-h-[300px] custom-scrollbar space-y-3">
