            ...
            <div class="glass-panel p-10 rounded-3xl border border-white/5 hover:border-cyber/30 transition-all group relative overflow-hidden">
              ...
              <div class="flex justify-between items-start mb-6 relative z-10">
                <div class="flex items-center gap-3">
                   <div class="px-3 py-1 rounded bg-cyber/10 border border-cyber/30 text-cyber text-[9px] font-black uppercase tracking-widest">\${s.source}</div>
                </div>
              ...
              <h3 class="text-2xl font-black text-white mb-4 tracking-tight group-hover:text-cyber transition-colors relative z-10">\${s.title}</h3>
              <p class="text-slate-400 mb-8 leading-relaxed line-clamp-3 relative z-10 font-medium">\${s.summary}</p>
              <div class="flex items-center justify-between relative z-10 pt-6 border-t border-white/5">
                <a href="\${s.link}" target="_blank" class="flex items-center gap-3 text-[10px] font-black text-cyber uppercase tracking-[0.2em] hover:gap-6 transition-all">
