    ...
    render() {
        ...
        this.innerHTML = `
            <div class="fixed inset-0 z-[10002] pointer-events-none overflow-hidden ">
                ...
                <div class="absolute top-1/4 left-0 w-full bg-danger/90 text-white py-10 border-y-4 border-white/20 transform -skew-y-2 backdrop-blur-md pointer-events-auto">
                    <div class="container mx-auto px-10 flex items-center justify-between">
                        <div class="flex items-center gap-10">
                            <div class="p-5 bg-white/20 rounded-full ">
                        ...
                        <button onclick="this.closest('alert-overlay').dismiss()" class="t-btn bg-white text-danger border-none px-10 py-5 text-xl font-black hover:bg-slate-200">ACKNOWLEDGE</button>
                    </div>
                </div>
