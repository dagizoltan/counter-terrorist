          ...
          <aside class="shell-sidebar relative">
            ...
            <nav class="flex-grow overflow-y-auto custom-scrollbar p-4 space-y-1">
              ...
              <div class="nav-group mb-8">
                ...
                <a href="/intel/center" class="nav-link">
                   <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="3"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="M2 12h2"/><path d="M20 12h2"/></svg>
                   Intelligence Center
                </a>
                <a href="/intel/center" class="nav-link">
                ...
                <a href="/intel/public-ip-collections" class="nav-link">
                   ...
                   Public IP Collections
                </a>

                <a href="/intel/artifact-collections" class="nav-link">
                   <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><circle cx="12" cy="12" r="4"/></svg>
                   Artifact Collections
                </a>

                <a href="/intel/feed" class="nav-link">
              ...
              <div class="nav-group pt-6 border-t border-white/5 mt-6 mb-12">
                ...
                <a href="/system/ledger" class="nav-link">
                ...
                <a href="/system/supply-chain" class="nav-link">
                   <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>
                   Supply Chain
                </a>
